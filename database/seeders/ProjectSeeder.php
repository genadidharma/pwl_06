...
class ProjectSeeder extends Seeder
{
    ...
    public function run()
    {
                $content_data = '<section class="project-detail section-padding">
        <div class="container">
             <div class="row">
        ...
        $data = [
            [
                'image' => 'images/project/project-image01.jpg',
                'category' => 'Marketing',
                'title' => 'Sweet Go Agency',
                'slug' => 'sweet-go-agency',
                'content' => $content_data,
            ],
            [
                'image' => 'images/project/project-image02.jpg',
                'category' => 'Website',
                'title' => 'Smart Ladies',
                'slug' => 'smart-ladies',
                'content' => $content_data,
            ...
            [
                'image' => 'images/project/project-image03.jpg',
